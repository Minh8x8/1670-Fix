...
namespace FPTBook.DataAccess.Migrations
{
    /// <inheritdoc />
    public partial class createdb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "DisplayOrder", "Name", "Status", "UserId" },
                values: new object[,]
                {
                    { 1, 1, "Action", "Approved", "" },
                    { 2, 2, "SciFi", "Approved", "" },
                    { 3, 3, "History", "Approved", "" }
                });
